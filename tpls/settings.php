...
<form action="" method="post" id="wptb">
    ...
    <div class="left width70">
        <table class="widefat">
                ...
                <tr>
                    ...
                    <td>
                        <select class="ps" rel="box1" name="sc_social_slider_position">
                            <option
                                value="left_slide" <?php if ("left_slide" == get_option('sc_social_slider_position')) echo 'selected="selected"'; ?>>
                                Sliding Icons (Left)
                            </option>
                            <option
                                value="left_tab" <?php if ("left_tab" == get_option('sc_social_slider_position')) echo 'selected="selected"'; ?>>
                                Pop-out Tabs (Left)
                            </option>
            ...
            <tr>
                <td>Widget Position from Top</td>
                <td>
<!--                    <label-->
<!--                        id="spos_box1">--><?php //if ("left" == get_option('sc_social_slider_position') || "right" == get_option('sc_social_slider_position')) echo "Top"; else echo "Left"; ?><!--</label><br>-->
                    <input type="text" name="sc_social_slider_margin"
                           value="<?php echo esc_attr( get_option('sc_social_slider_margin') ); ?>" size="10" class="width25"/>px
                </td>
            </tr>
            </tbody>
        </table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="bg_colorbox" name="sc_social_slider_background"
                               value="<?php echo esc_attr( get_option('sc_social_slider_background') ); ?>" size="10" class="width25"/>
                    </td>
                </tr>
                <tr>
                    <td>Text Color</td>
                    <td>
                        <input type="text" id="text_colorbox" name="sc_social_slider_color"
                               value="<?php echo esc_attr( get_option('sc_social_slider_color') ); ?>" size="10" class="width25"/>
                    </td>
                </tr>
            </tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="sc_social_slider_facebook"
                           value="<?php echo esc_attr( get_option('sc_social_slider_facebook') ); ?>"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="sc_social_slider_gplus"
                           value="<?php echo esc_attr( get_option('sc_social_slider_gplus') ); ?>"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="sc_social_slider_youtube"
                           value="<?php echo esc_attr( get_option('sc_social_slider_youtube') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Linkedin</td>
                <td>
                    <input type="text" name="sc_social_slider_linkedin"
                           value="<?php echo esc_attr( get_option('sc_social_slider_linkedin') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Email Address</td>
                <td>
                    <input type="text" name="sc_social_slider_email"
                           value="<?php echo esc_attr( get_option('sc_social_slider_email') ); ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input id="ssi-shortcode" type="text" name="sc_social_slider_shortcode"
                           value="<?php echo esc_attr( get_option('sc_social_slider_shortcode') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Twitter</td>
                <td>
                    <input type="text" name="sc_social_slider_twitter"
                           value="<?php echo esc_attr( get_option('sc_social_slider_twitter') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Instagram</td>
                <td>
                    <input type="text" name="sc_social_slider_instagram"
                           value="<?php echo esc_attr( get_option('sc_social_slider_instagram') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Phone Number</td>
                <td>
                    <input type="text" name="sc_social_slider_phone"
                           value="<?php echo esc_attr( get_option('sc_social_slider_phone') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Pinterest</td>
                <td>
                    <input type="text" name="sc_social_slider_pinterest"
                           value="<?php echo esc_attr( get_option('sc_social_slider_pinterest') ); ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="sc_social_slider_skype"
                           value="<?php echo esc_attr( get_option('sc_social_slider_skype') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Foursquare</td>
                <td>
                    <input type="text" name="sc_social_slider_foursquare"
                           value="<?php echo esc_attr( get_option('sc_social_slider_foursquare') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>GitHub</td>
                <td>
                    <input type="text" name="sc_social_slider_github"
                           value="<?php echo esc_attr( get_option('sc_social_slider_github') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td>Tumblr</td>
                <td>
                    <input type="text" name="sc_social_slider_tumblr"
                           value="<?php echo esc_attr( get_option('sc_social_slider_tumblr') ); ?>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="sc_social_slider_store"
                           value="<?php echo esc_attr( get_option('sc_social_slider_store') ); ?>"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
