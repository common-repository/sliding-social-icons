...
if(!defined('SC_SOCIAL_SLIDER_VERSION'))
    define('SC_SOCIAL_SLIDER_VERSION','1.61');
...
function sc_social_slider_register_options() {
    ...
    $sc_social_slider_options = array(
        ...
        'sc_social_slider_position' => 'left_tab',
        'sc_social_slider_background' => '#60b2f0',
...
function sc_social_slider_styles_scripts() {
    ...
    // plugin main style
    wp_enqueue_style('sc_social_slider_default_style', SC_SOCIAL_SLIDER_PATH . 'css/site/sc_social_slider.css', false, '1.61');
    wp_enqueue_style('sc_social_slider_icons', SC_SOCIAL_SLIDER_PATH . 'css/font-awesome.min.css', false, '1.61');
    wp_enqueue_style('sc_social_slider_template_style', SC_SOCIAL_SLIDER_PATH . 'css/site/' . get_option('sc_social_slider_position') . '.css', false, '1.61');
    
    // plugin main script
    wp_enqueue_script('sc_social_slider_default_script', SC_SOCIAL_SLIDER_PATH . 'js/site/sc_social_slider.js', array('jquery'), '1.61');
}
